# Project Euler | Problem 11 | Jacob Waters
...
def productGrid(n):
    ...
    for i in range(0, 20):  # row
        for j in range(0, 17):  # column
            calc = n[i][j] * n[i][j+1] * n[i][j+2] * n[i][j+3]
    ...
    for i in range(0, 17):  # row
        for j in range(0, 20):  # column
            calc = n[i][j] * n[i+1][j] * n[i+2][j] * n[i+3][j]
            if calc > largestProduct:
                largestProduct = calc
    ...
    for i in range(0, 17):  # row
        for j in range(0, 17):  # column
            calc = n[i][j] * n[i+1][j+1] * n[i+2][j+2] * n[i+3][j+3]
